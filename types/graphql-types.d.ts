...
export type FileFieldsEnum = 
  ...
  | 'childMarkdownRemark___frontmatter___thumbnailImage'
...
export type MarkdownRemarkFrontmatterFilterInput = {
  ...
  thumbnailImage?: Maybe<StringQueryOperatorInput>;
};
...
export type SitePageFieldsEnum = 
  ...
  | 'pluginCreator___pluginOptions___aliases___ts'
...
export type GithubLinkDataQueryVariables = Exact<{ [key: string]: never; }>;
